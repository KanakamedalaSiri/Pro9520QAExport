...
var config = {
    ...
    strictMode: buildProps.strictmode || false,
    buildNativeInstaller: buildProps.buildNativeInstaller || false
};
...
function getOptionIndex(cmdArguments, flag) {
    ...
    switch (flag) {
        case 'clean':
            ...
            case 'download':
                if(cmdArguments.indexOf('-iv') >= 0) {
                    index = cmdArguments.indexOf('-iv');
                } else if(cmdArguments.indexOf('--irisversion') >= 0) {
                    index = cmdArguments.indexOf('--irisversion');
                } else if(cmdArguments.indexOf('-kvv') >= 0) {
        ...
        case 'misc':
            ...
            cmdArguments.indexOf('-iv') < 0 && cmdArguments.indexOf('--irisversion') < 0 ||
            cmdArguments.indexOf('-kv') < 0 && cmdArguments.indexOf('--konyvizversion') < 0 &&
...
function printHelpContent() {
    var helpContent = '\nUsage: node build.js [arguments]\n\n' +  
        ...
        '--irisversion, -iv         To download plugins of specified VoltMx Iris version.\n' +
        ...
        'Usage:                     node build.js --clean --irisversion 8.4.0 --proxy \n' +
